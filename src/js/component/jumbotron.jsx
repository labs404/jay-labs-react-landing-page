...
const Jumbotron = () => {
    return(
        <div className="p-4 bg-secondary-subtle border border-dark rounded-3 mt-5" id="jumbotron">
            ...
            <a className="btn btn-outline-danger" type="button" href="https://en.wikipedia.org/wiki/Trent_Reznor" target="_blank">Trent Reznor Wiki</a> <a className="btn btn-outline-danger" type="button" href="https://en.wikipedia.org/wiki/Nine_Inch_Nails" target="_blank">Nine Inch Naile Wiki</a>
        </div>
    );
}
